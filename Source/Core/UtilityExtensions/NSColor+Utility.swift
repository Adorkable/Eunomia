...
//  Eunomia
//
//  Created by Ian Grossberg on 10/5/18.
...
extension NSColor {
    ...
    public class func randomColor(alpha : CGFloat = 1.0) -> NSColor {
        return NSColor(red: self.randomComponent(), green: self.randomComponent(), blue: self.randomComponent(), alpha: alpha)
    }
    
    public class func randomColorWithRandomAlpha() -> NSColor {
    ...
    public class func randomColor(minimumIntensity : CGFloat) -> NSColor {
    ...
    public class func colorWithRGBComponents(_ components : [CGFloat]) -> NSColor {
